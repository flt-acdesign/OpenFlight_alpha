...
function gather_telemetry(aircraft_state_data, control_demand_vector, elapsed_time, df)
    ...
    push!(df, (
        ...
        thrust_setting_demand = round(control_demand_vector[:thrust_setting_demand], digits=DECIMAL_PLACES),
        thrust_attained = round(control_demand_vector[:thrust_attained], digits=DECIMAL_PLACES)
